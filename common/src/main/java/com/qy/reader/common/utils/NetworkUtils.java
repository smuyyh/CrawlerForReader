...
public final class NetworkUtils {
    ...
    public static void openWirelessSettings() {
        Global.getApplication().startActivity(new Intent(android.provider.Settings.ACTION_WIRELESS_SETTINGS)
    ...
    private static NetworkInfo getActiveNetworkInfo() {
        ConnectivityManager manager =
                (ConnectivityManager) Global.getApplication().getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) Global.getApplication().getSystemService(Context.WIFI_SERVICE);
